...
class _LoginPageState extends State<LoginPage> with MessagesViewMixin {
  ...
  void initState() {
    ...
    //! apos adicionar o with messageviewmixin, deve chamar o message no initState
    //* utilizando o effects para ficar escutando e com isso realizar o redirecionamento
    effect(() => {
              ...
              child: Form(
                ...
                child: Column(
                  children: [
                    ...
                    //! NESSE CASO AO INVEZ DE COLOCAR UM SETSTATE O SIGNALS TRABALHA COM O WATCH NAO ESQUECER!!!!
                    Watch((_) {
